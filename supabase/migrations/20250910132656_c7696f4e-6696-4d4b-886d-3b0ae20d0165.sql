-- Update Community System Schema to match architecture
...
-- Create community_data_distribution table for workflow management
...
-- Enable RLS on community_data_distribution
ALTER TABLE public.community_data_distribution ENABLE ROW LEVEL SECURITY;

-- Create policies for community_data_distribution
...
-- Create community_data table for additional community data
...
-- Enable RLS on community_data
ALTER TABLE public.community_data ENABLE ROW LEVEL SECURITY;

-- Create policies for community_data
...
-- Create community_members table to track membership
...
-- Create knowledge_base table referenced in the ERD
...
-- Update communities table policies to be more comprehensive
...
-- Create new comprehensive policies for communities
...
-- Add auto-membership for community creators
...
-- Create function to get community member count
...
-- Update the get_managed_communities function to return actual member counts
