-- Update Community System Schema - Clean approach
...
-- Create community_data_distribution table if it doesn't exist
...
-- Create community_data table if it doesn't exist
...
DROP POLICY IF EXISTS "Users can view their own submissions" ON public.community_data_distribution;
DROP POLICY IF EXISTS "Users can create submissions" ON public.community_data_distribution;
DROP POLICY IF EXISTS "Admins can view all submissions" ON public.community_data_distribution;
DROP POLICY IF EXISTS "Admins can update submissions" ON public.community_data_distribution;

DROP POLICY IF EXISTS "Community data is viewable by members" ON public.community_data;
DROP POLICY IF EXISTS "Community owners can manage data" ON public.community_data;

DROP POLICY IF EXISTS "Published knowledge base is viewable by community members" ON public.knowledge_base;
DROP POLICY IF EXISTS "Authors can manage their knowledge base entries" ON public.knowledge_base;
DROP POLICY IF EXISTS "Community owners can manage knowledge base" ON public.knowledge_base;
