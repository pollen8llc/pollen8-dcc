...
const OutreachDetails = lazy(() => import("@/pages/rel8/OutreachDetails"));
...
const OrbitDetails = lazy(() => import("@/pages/OrbitDetails"));
    ...
    <ErrorBoundary>
      <Suspense fallback={<AppLoadingSpinner />}>
        <Routes>
          ...
          <Route path="/rel8/categories/:id" element={
            <NonServiceProviderRoute>
              <ProtectedRoute>
                <CategoryDetail />
              </ProtectedRoute>
          ...
          <Route path="/rel8/outreach/:id" element={
            <NonServiceProviderRoute>
              <ProtectedRoute>
                <OutreachDetails />
              </ProtectedRoute>
          ...
          {/* REL8 Actv8 Hub and Sub-pages */}
          <Route path="/rel8/actv8" element={
            <NonServiceProviderRoute>
              <ProtectedRoute>
                <Network />
              </ProtectedRoute>
          ...
          <Route path="/rel8/actv8/:id/strategy" element={
            <NonServiceProviderRoute>
              <ProtectedRoute>
                <NetworkStrategy />
              </ProtectedRoute>
