...
const AppRoutes = () => {
  console.log('AppRoutes: Rendering routes component');

  return (
    <ErrorBoundary fallback={<div className="p-8 text-center"><h2>Error loading application routes</h2><p>Please check the browser console for details.</p></div>}>
