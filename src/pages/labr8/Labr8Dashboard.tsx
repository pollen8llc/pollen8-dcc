...
const Labr8Dashboard = () => {
  ...
  // Include 'agreed', 'in_progress', and 'agreement' (finalization) in active projects
  const activeProjects = assignedRequests.filter(r => ['agreed', 'in_progress', 'agreement'].includes(r.status));
