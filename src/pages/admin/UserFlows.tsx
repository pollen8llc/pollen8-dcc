    ...
    flows: [
      {
        ...
        steps: [
          "Navigate to A10D Dashboard",
          "Click 'Import Contacts'",
          "Select import method (CSV, Email, Phone, Website)",
          "Upload/Configure data source",
          "Map contact fields",
          "Review and validate contacts",
      ...
      },
      {
        ...
        steps: [
          "Access A10D Dashboard",
          "View contact profiles grid",
    ...
    flows: [
      {
        ...
        steps: [
          "Access REL8T Dashboard",
          "Navigate to Contacts section",
          "Create new contact or import",
          "Assign categories and tags",
          "Set relationship priority",
          "Configure outreach triggers"
        ],
      ...
      },
      {
        ...
        steps: [
          ...
          "Create new trigger",
          "Select trigger type (time-based, event-based)",
          "Configure trigger conditions",
          "Set up notification template",
          "Test and activate trigger"
        ],
      ...
      },
      {
        ...
        steps: [
          "Access Dashboard",
          "Review contact segments",
          "Create outreach campaign",
          "Select target contacts",
          "Design email template",
          "Schedule and send campaign",
    ...
    flows: [
      {
        ...
        steps: [
          "Access MODUL8 Dashboard",
          "Create new service request",
          "Fill request details and requirements",
          "Submit request to provider network",
          "Review incoming proposals",
          "Negotiate terms and scope",
          "Accept proposal and start project"
        ],
    ...
    flows: [
      {
        ...
        steps: [
          ...
          "Choose content type (Article, Poll, Question, Quote)",
          "Create content using editor",
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        {moduleFlows.map((module) => {
          ...
          return (
            <div key={module.id} className="glass-morphism glass-morphism-hover rounded-3xl p-8 border border-primary/20">
              {/* Module Header */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {module.flows.map((flow, flowIndex) => (
                  <Card key={flowIndex} className="glass-morphism border border-primary/10">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {flow.entryPoints.map((entry, entryIndex) => (
                            <Badge key={entryIndex} variant="outline" className="text-xs">
                              {entry}
                            </Badge>
                          ))}
                        </div>
      ...
      <div className="glass-morphism glass-morphism-hover rounded-3xl p-6 border border-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-primary">
              {moduleFlows.reduce((acc, module) => 
                acc + module.flows.reduce((flowAcc, flow) => flowAcc + flow.steps.length, 0), 0
              )}
            </div>
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-primary">
              {moduleFlows.reduce((acc, module) => 
                acc + module.flows.reduce((flowAcc, flow) => flowAcc + flow.entryPoints.length, 0), 0
              )}
            </div>
