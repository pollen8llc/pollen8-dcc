      ...
      try {
        ...
        if (!isOwnProfile && currentUser) {
          ...
          try {
            ...
            console.error("Error getting connection depth:", err);
            // Continue even if connection depth fails
          }
      ...
      <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="max-w-md mx-auto">
            ...
            <CardContent>
              <p>We encountered a problem loading this profile.</p>
            </CardContent>
            <AlertDialogFooter>
            ...
            <div className="max-w-4xl mx-auto">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {isOwnProfile && profile.privacy_settings && (
