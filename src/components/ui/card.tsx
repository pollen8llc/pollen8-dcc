...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 text-white shadow-lg hover:shadow-[#00eada]/10 transition-all duration-200 flex flex-col h-full",
      className
    )}
    {...props}
  />
