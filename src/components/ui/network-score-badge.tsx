...
export const NetworkPlexus: React.FC = () => {
  ...
  const nodes = [
    { id: 0, cx: 5, cy: 5 },      // Top-left corner
    { id: 1, cx: 12, cy: 5 },     // Top-middle
    { id: 2, cx: 19, cy: 5 },     // Top-right corner
    { id: 3, cx: 19, cy: 12 },    // Right-middle
    { id: 4, cx: 19, cy: 19 },    // Bottom-right corner
    { id: 5, cx: 12, cy: 19 },    // Bottom-middle
    { id: 6, cx: 5, cy: 19 },     // Bottom-left corner
    { id: 7, cx: 5, cy: 12 },     // Left-middle
  ];
  ...
  return (
    <div className="relative w-10 h-10 flex-shrink-0">
      <svg viewBox="0 0 24 24" className="w-full h-full">
        {/* Static connection lines (square perimeter) with 5px inset */}
        <line x1="5" y1="5" x2="12" y2="5" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="12" y1="5" x2="19" y2="5" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="19" y1="5" x2="19" y2="12" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="19" y1="12" x2="19" y2="19" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="19" y1="19" x2="12" y2="19" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="12" y1="19" x2="5" y2="19" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="5" y1="19" x2="5" y2="12" stroke="white" strokeWidth="0.5" opacity="0.2" />
        <line x1="5" y1="12" x2="5" y2="5" stroke="white" strokeWidth="0.5" opacity="0.2" />
