...
const channelOptions = [
  ...
  { value: "meeting", label: "Virtual Meeting", icon: Video },
  { value: "irl", label: "In-Person Meeting", icon: MapPin },
];
...
export function FollowUpChannelStep({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {selectedChannel && (
        <Card className="p-6 backdrop-blur-sm bg-card/80 border-primary/20 animate-fade-in">
